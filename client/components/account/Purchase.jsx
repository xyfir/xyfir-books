...
export default class Purchase extends React.Component {
  ...
  onSlide(tier) {
    const state = (() => {
      switch (tier) {
        case 1:
          return { tier: 1, gb: 1, price: 5 };
        case 2:
          return { tier: 2, gb: 10, price: 15 };
        case 3:
          return { tier: 3, gb: 15, price: 20 };
        default:
          return {
            tier,
            gb: tier * 5,
  ...
  render() {
    ...
    if (referral.source == 'swiftdemand' && !referral.hasMadePurchase)
      return (
        <Paper
          zDepth={1}
          component="section"
        ...
        >
          <p>
            You can purchase a one-time, three month, 1GB subscription using
            SwiftDemand.
          </p>

          <Button primary raised onClick={() => this.onPurchase('swiftdemand')}>
            Purchase
          </Button>
        </Paper>
      );
      ...
      return (
        ...
        >
          <Slider
            ...
            step={1}
            label={`Premium Subscription (${gb}GB, $${
